          ...
          <div className="bg-card border border-border/50 rounded-2xl shadow-sm overflow-hidden flex flex-col flex-1">
            ...
            <div className="p-5 flex-1 bg-black/10 flex flex-col gap-5">
              {isPreviewLoading ? (
                ...
                <div className="h-full flex flex-col items-center justify-center text-red-500/80 space-y-2 py-20 text-center px-6">
                  <AlertCircle className="w-8 h-8 opacity-50 mb-2 text-red-500" />
                  <p className="text-sm font-bold">Failed to load preview</p>
                  <p className="text-xs max-w-md">{previewError}</p>
                </div>
              ) : (
