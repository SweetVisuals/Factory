      ...
      <div className="max-w-6xl mx-auto px-4 py-8 space-y-12">
        ...
        <div className="flex items-center gap-4 border-b border-white/10 pb-4">
          <button 
            ...
            className={`text-sm font-bold uppercase tracking-widest px-4 py-2 rounded-full transition-colors ${activeTab === 'profile' ? 'bg-primary/20 text-primary' : 'text-white/40 hover:text-white/80'}`}
          >
            Identity Profile
          </button>
          <button 
            onClick={() => setActiveTab('usage')}
            className={`text-sm font-bold uppercase tracking-widest px-4 py-2 rounded-full transition-colors ${activeTab === 'usage' ? 'bg-primary/20 text-primary' : 'text-white/40 hover:text-white/80'}`}
          >
            System Usage
          </button>
        </div>
