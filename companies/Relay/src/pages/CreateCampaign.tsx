    ...
    <Layout>
      <div className="w-full flex flex-col h-full bg-background overflow-y-auto text-foreground animate-in fade-in duration-200">
        ...
        <div className="p-4 md:p-8 md:pb-4 shrink-0">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 md:gap-8 max-w-[1600px] mx-auto w-full">
        ...
        <div className="flex-1 p-4 md:p-8 max-w-[1600px] mx-auto w-full">
          <Card className="border-border shadow-2xl bg-card overflow-hidden">
            <CardHeader className="border-b border-border bg-muted/30 p-4 md:p-8">
              <CardTitle className="text-xl md:text-2xl font-bold text-foreground">Campaign Details</CardTitle>
              <p className="text-muted-foreground mt-1 text-sm md:text-base">Configure your new outreach campaign settings below.</p>
            </CardHeader>
            <CardContent className="p-4 md:p-8">
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div className="flex flex-col-reverse md:flex-row md:items-center md:justify-end gap-3 md:space-x-4 pt-6 border-t border-border">
                  <button
                    onClick={() => navigate('/campaigns')}
                    type="button"
                    className="w-full md:w-auto px-6 py-2.5 rounded-xl border-none border-border text-foreground hover:bg-muted font-medium transition-all"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    className="w-full md:w-auto px-8 py-2.5 bg-primary text-primary-foreground rounded-xl hover:bg-primary/90 font-bold transition-all shadow-lg shadow-primary/30"
                  >
                    Create Campaign
                  </button>
                </div>
