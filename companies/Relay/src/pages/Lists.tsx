...
const Lists = () => {
    ...
    const renderListCard = (list: any, index: number, arrayContext: any[]) => {
        ...
        return (
            <div
                ...
                className={cn(
                    "cursor-pointer p-4 rounded-none transition-all duration-500 group relative overflow-hidden active:cursor-grabbing",
            ...
            >
                <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                        <div className={cn(
                            "p-1.5 rounded-none transition-all duration-500",
                ...
                <h3 className={cn(
                    "text-[11px] font-black uppercase tracking-[0.1em] truncate pr-4 transition-colors duration-500",
    ...
    return (
        <Layout>
            <div className="flex flex-col h-[calc(100vh-theme(spacing.12))] gap-6 p-6">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="text-sm font-black text-foreground uppercase tracking-widest flex items-center gap-3">
                                        Global Redundancies
                                        <span className="text-[10px] font-black text-amber-500 bg-amber-500/10 px-3 py-1 rounded-none tracking-[0.2em]">
                            ...
                            <div className="flex items-center gap-4">
                                {isDuplicateCardExpanded && (
                                    <Button
                                        ...
                                        className="bg-primary hover:bg-primary/90 text-primary-foreground text-[10px] font-black uppercase tracking-widest px-6 h-10 rounded-none shadow-lg shadow-primary/20"
                                    >
                                        <Zap className="w-3 h-3 mr-2" />
                                        {isRemovingDuplicates ? 'Processing...' : 'Global Cleanup'}
                                    </Button>
                                )}
                                <div className={cn("p-2 rounded-none bg-foreground/[0.02] text-muted-foreground/40 transition-transform duration-500", isDuplicateCardExpanded && "rotate-180")}>
                                    <ChevronDown size={14} />
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 max-h-[300px] overflow-y-auto pr-2 scrollbar-none">
                                    {crossListDuplicates.map((dup) => {
                                        ...
                                        return (
                                            <div
                                                key={dup.email}
                                                className="flex flex-col p-5 rounded-none bg-foreground/[0.02] hover:bg-foreground/[0.03] transition-all group relative overflow-hidden"
                                            >
                                                <div className="flex items-start justify-between">
                                                    <div className="min-w-0 flex-1">
                                                        ...
                                                        <div className="flex flex-wrap gap-2">
                                                            {uniqueLists.map(([listId, listName]) => (
                                                                <span
                                                                    key={listId}
                                                                    className="inline-flex items-center text-[8px] font-black text-muted-foreground/60 bg-foreground/[0.02] px-2 py-1 rounded-none uppercase tracking-widest"
                                                                >
                                                                    {listName}
                                                                </span>
                                                            ))}
                                                    ...
                                                    <Button
                                                        ...
                                                        disabled={isRemoving}
                                                        className="h-8 w-8 text-destructive/40 hover:text-destructive hover:bg-destructive/10 rounded-none opacity-0 group-hover:opacity-100 transition-all"
                                                    >
                ...
                <div className="flex-1 flex gap-6 min-h-0">
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center justify-between">
                                ...
                                <Button
                                    variant="ghost"
                                    size="icon"
                                    className="h-10 w-10 rounded-none bg-foreground/[0.02] hover:bg-primary/10 hover:text-primary transition-all duration-500"
                            ...
                            {selectedListIds.size > 0 && (
                                <div className="p-4 bg-primary/10 rounded-none flex items-center justify-between animate-in fade-in slide-in-from-top-4 duration-500 shadow-lg shadow-primary/5">
                                    <div className="flex items-center gap-4">
                                        <div className="p-2 bg-primary text-primary-foreground rounded-none shadow-lg shadow-primary/20">
                                            <span className="text-[10px] font-black uppercase tracking-widest">{selectedListIds.size}</span>
                                        </div>
                                        <Button 
                                            variant="ghost" 
                                            size="sm" 
                                            className="h-8 text-[10px] font-black uppercase tracking-widest text-primary/60 hover:text-primary"
                                    ...
                                    <Button
                                        variant="destructive"
                                        size="sm"
                                        className="h-9 px-4 text-[10px] font-black uppercase tracking-widest rounded-none shadow-lg shadow-destructive/20"
                            ...
                            {isCreatingFolder && (
                                <div className="flex items-center gap-2 p-2 bg-foreground/[0.01] rounded-none animate-in zoom-in-95 duration-500">
                                    <Input
                                        placeholder="Sector name..."
                                        value={newFolderName}
                                        onChange={(e) => setNewFolderName(e.target.value)}
                                        className="h-10 text-[10px] font-black uppercase tracking-widest bg-transparent border-none focus-visible:ring-0"
                                        autoFocus
                                        onKeyDown={(e) => {
                                    ...
                                    />
                                    <Button size="sm" className="h-10 px-4 rounded-none bg-primary text-primary-foreground" onClick={handleCreateFolder}>ADD</Button>
                                </div>
                            )}
                            ...
                            <div className="relative group">
                                ...
                                <Input
                                    ...
                                    className="h-12 pl-12 bg-foreground/[0.01] border-none rounded-none text-[10px] font-black uppercase tracking-widest focus-visible:ring-1 ring-primary/20 transition-all"
                                />
                            </div>
                        </div>
                        ...
                        <div className="flex-1 overflow-y-auto space-y-4 pr-2 scrollbar-none">
                            {loading ? (
                                ...
                                <div className="text-center py-24 space-y-4">
                                    <div className="w-16 h-16 bg-foreground/[0.01] rounded-none flex items-center justify-center mx-auto">
                                ...
                                <>
                                    {folders.map(folder => {
                                        ...
                                        return (
                                            <div
                                                key={folder.id}
                                                className={cn(
                                                    "space-y-1 transition-all duration-500 rounded-none p-1",
                                            ...
                                            >
                                                <div
                                                    className={cn(
                                                        "flex items-center justify-between group px-4 py-3 rounded-none transition-all duration-500 cursor-pointer",
                                                ...
                                                >
                                                    <div className="flex items-center gap-3 min-w-0">
                                                        ...
                                                        <Folder size={14} className={cn("shrink-0 transition-colors duration-500", isExpanded ? "text-primary" : "text-muted-foreground/30")} />
                                                        <span className="text-[11px] font-black uppercase tracking-widest truncate text-foreground/80">{folder.name}</span>
                                                        <span className="text-[8px] font-black text-muted-foreground/30 bg-foreground/[0.02] px-2 py-0.5 rounded-none tracking-widest">
                                                            {leadCount}
                                                        </span>
                                                    </div>
                                    ...
                                    <div className="pt-8">
                                        <div className="flex items-center justify-between px-4 mb-4">
                                            ...
                                            <span className="text-[8px] font-black text-muted-foreground/20 bg-foreground/[0.02] px-2 py-0.5 rounded-none tracking-widest">{localLists.length} FILES</span>
                                        </div>
                                        <div className="space-y-2">
                                            {localLists.map((local) => (
                                                <div
                                                    ...
                                                    className={cn(
                                                        "cursor-pointer p-4 rounded-none transition-all duration-500 group relative overflow-hidden",
                                    ...
                                    {groupedLists.unassigned.length > 0 && (
                                        <div
                                            className={cn(
                                                "space-y-2 rounded-none transition-all duration-500 p-1 group/unassigned",
                                            ...
                                            {folders.length > 0 && (
                                                <div className="flex items-center justify-between px-4 mt-8 mb-2">
                                                    ...
                                                    <Button 
                                                        variant="ghost" 
                                                        size="sm" 
                                                        className="h-5 px-2 text-[8px] font-black uppercase tracking-widest opacity-0 group-hover/unassigned:opacity-100 transition-all duration-500"
                                                        onClick={() => {
                                                            const newSelection = new Set(selectedListIds);
                    ...
                    {/* Main Workspace */}
                    <div className="flex-1 flex flex-col h-full overflow-hidden bg-foreground/[0.01] rounded-none relative">
                        {activeTab === 'discovery' ? (
                            <div className="flex-1 overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-700">
                                ...
                                <div className="p-10 flex justify-between items-center relative overflow-hidden shrink-0">
                                    ...
                                    <div className="flex items-center gap-4 relative z-10">
                                        {scrapeStatus !== 'idle' && (
                                            <div className="flex items-center gap-2 px-4 py-2 bg-primary/10 text-primary">
                                                <div className="w-1.5 h-1.5 bg-primary animate-pulse" />
                                                <span className="text-[9px] font-black uppercase tracking-widest">{scrapeStatus}</span>
                                            </div>
                                        )}
                                        <div className="flex items-center gap-2 px-4 py-2 bg-foreground/[0.02] text-muted-foreground/40">
                                            <Activity size={12} />
                            ...
                            <div className="flex-1 overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-700">
                                <div className="p-10 flex justify-between items-center relative overflow-hidden">
                                    ...
                                    <div className="relative z-10">
                                        <div className="flex items-center gap-4">
                                            ...
                                            {duplicatesFound && (
                                                <div className="bg-destructive text-primary-foreground text-[10px] font-black px-4 py-1.5 rounded-none uppercase tracking-widest shadow-lg shadow-destructive/20 animate-pulse">
                                                    REDUNDANCY DETECTED
                                                </div>
                                            )}
                                        </div>
                                ...
                                <div className="flex-1 overflow-y-auto px-10 pb-10 scrollbar-none">
                                    <div className="bg-foreground/[0.01] rounded-none p-2 relative">
                                        <LeadTable
                                            leads={currentLeads}
                            ...
                            <div className="flex-1 flex flex-col items-center justify-center text-center p-24 space-y-12">
                                <div className="relative">
                                    <div className="absolute inset-0 bg-primary/20 blur-[100px] rounded-none" />
                                    <div className="w-40 h-40 rounded-none bg-foreground/[0.01] flex items-center justify-center relative backdrop-blur-3xl">
            ...
            <Dialog open={isFolderValidating} onOpenChange={(open) => {
                ...
                <DialogContent className="sm:max-w-md bg-background/95 backdrop-blur-3xl border-none text-foreground shadow-2xl rounded-none p-12 overflow-hidden">
                    ...
                    <div className="py-12 space-y-12">
                        <div className="space-y-4">
                            ...
                            <div className="h-2 w-full bg-foreground/[0.02] rounded-none overflow-hidden">
                                <div
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="p-8 rounded-none bg-emerald-500/5 text-center space-y-2 group">
                            ...
                            <div className="p-8 rounded-none bg-destructive/5 text-center space-y-2 group">
...
const LocalArchiveViewer = ({ filename, onImport, isImporting }: { filename: string, onImport: () => void, isImporting: boolean }) => {
    ...
    return (
        <div className="flex-1 overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-700">
            <div className="p-10 flex justify-between items-center relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="bg-foreground/[0.03] text-muted-foreground/60 text-[8px] font-black px-3 py-1 rounded-none uppercase tracking-[0.2em]">
                            LOCAL ARCHIVE
                        </div>
                    </div>
                    <div className="flex items-center gap-3 mt-4">
            ...
            <div className="flex-1 overflow-y-auto px-10 pb-10 scrollbar-none">
                <div className="bg-foreground/[0.01] rounded-none p-2 relative overflow-hidden">
                    {loading ? (
