                                            ...
                                            <div key={overlay.id} className="p-3 rounded-none bg-black/20 border-0 space-y-3 hover:bg-white/5 transition-colors">
                                                ...
                                                <div className="flex gap-2">
                                                    ...
                                                    <div className="flex-1 flex gap-1 bg-black/20 p-1 rounded-none">
                                                        <Button
                                                            ...
                                                            onClick={() => onUpdateTextOverlay(overlay.id, { bold: !overlay.bold, fontWeight: !overlay.bold ? '700' : '400' })}
                                                        >
                                                            B
                                                        </Button>
                                                        <Button
                                                ...
                                                {overlay.outline && (
                                                    <div className="space-y-2 pt-1">
                                                        <div className="flex items-center gap-2">
                                                            <div className="relative w-7 h-7 rounded-none overflow-hidden shrink-0">
                                                                <input
                                                                    type="color"
                                                                    value={overlay.outlineColor || '#000000'}
                                                                    onChange={(e) => onUpdateTextOverlay(overlay.id, { outlineColor: e.target.value })}
                                                                    className="absolute -top-2 -left-2 w-12 h-12 cursor-pointer p-0 border-0"
                                                                />
                                                            </div>
                                                            <div className="flex-1 space-y-1">
                                                                <Label className="text-[10px] text-muted-foreground">Outline: {overlay.outlineWidth || 2}px</Label>
                                                                <Slider
                                                                    value={[overlay.outlineWidth || 2]}
                                                                    min={1}
                                                                    max={10}
                                                                    step={0.5}
                                                                    onValueChange={([v]) => onUpdateTextOverlay(overlay.id, { outlineWidth: v })}
                                                                    className="py-1"
                                                                />
                                                            </div>
                                                        </div>
