  ...
  try {
    ...
    for (const schedule of filteredSchedules) {
        ...
        for (const lead of pendingLeads) {
             ...
             // Force AI personalization if we don't have bodyContent/subjectContent yet (for ALL steps, to ensure uniqueness)
             const needsPersonalization = (!bodyContent || !subjectContent);
...
"3. Rewrite the provided Original Template Body to make it highly unique, natural, and personalized for this lead. If the original template is a follow-up, KEEP IT as a follow-up (don't turn it into an opener). Keep it SHORT and conversational.\n" +
"4. DO NOT pitch our services directly unless the original template does. The goal is to sound human and start a conversation.\n" +
"5. ABSOLUTELY DO NOT include any sign-off, closing, or signature. No Best, Regards, Cheers, Thanks, Sincerely, or ANY name (e.g. Ethan, Oliver) at the end. The system auto-appends the sender signature. Including one causes a DUPLICATE.\n" +
